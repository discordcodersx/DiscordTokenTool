...
def cycle_token_status(Token):
    headers = {"authorization": Token, "user-agent": "Samsung Fridge/6.9"}
    for i in range(0, 50):
        json = {"custom_status": {"text": "MeyzShop", "emoji_name": "🍉"}}
        requests.patch(
...
def main():
    Test_Token = input("Token Giriniz: ")
    tittle()
    ...
    choose_nuke = input("Lütfen Listeden Bir Seçenek Giriniz: ")
